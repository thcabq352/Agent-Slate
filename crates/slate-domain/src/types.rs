...
pub struct VoiceSheet {
    ...
    pub notes: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub grok_voice_id: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub vo_text: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub vo_path: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub vo_language: Option<String>,
}
...
/// `cursor` / `grok-4.5` / `grok-4.6` use Cursor CLI with OAuth.
/// Old project JSON `"claude"` deserializes as Cursor.
